...
// Fetch-on-load side already existed (GET /:id includes the ordered
// `message` relation, built for G411-67/75) — this is the write half.
// Owner-or-admin, same convention as GET/PATCH :id on this router: a
// non-owner gets 404, not 403, so they can't even confirm the request
// exists. ADMIN role isn't assignable yet (G411-76) — only owners can
// practically hit this until then, endpoint is still correct either way.
